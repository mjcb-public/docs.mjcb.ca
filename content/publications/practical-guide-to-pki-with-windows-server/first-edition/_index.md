...
![Practical Guide to PKI with Windows Server - First Edition](/images/publications/practical-guide-to-pki-with-windows-server/first-edition/practical-guide-to-pki-with-windows-server-first-edition.png)
...
For more information on how I wrote the book and what challenges I encountered while writing it, check out the [Practical Guide to PKI with Windows Server – Behind the Scenes](https://mjcb.ca/blog/2021/09/23/practical-guide-to-pki-with-windows-server-behind-the-scenes/) page.

For a follow-up on this book, check out the [Practical Guide to PKI with Windows Server - One Year Later](https://mjcb.ca/blog/2022/09/27/practical-guide-to-pki-with-windows-server-one-year-later/) page.
...
For customers who purchased the paperback version of this book, you can find all of the commands that are printed in the book by visiting this [page](/publications/practical-guide-to-pki-with-windows-server/first-edition/command-listing/).
